...
export default function ExerciseTimer() {
  ...
  const handleStop = async () => {
    ...
    const durationForDisplay = Math.floor(time / 60); 
    
    
    const exactDurationInMinutes = time / 60;
    const calories = calculateCalories(exactDurationInMinutes);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.timerContainer}>
        ...
        <Text style={styles.calories}>
          预计消耗: {Math.round(calculateCalories(time / 60))} 卡
        </Text>
      </View>
